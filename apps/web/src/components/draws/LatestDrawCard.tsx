  ...
  return (
    <div className="bg-[var(--color-surface)] rounded-xl border border-[var(--color-border)] p-5">
      <div className="flex items-center justify-between mb-4">
        <div>
          <span className="text-xs text-[var(--color-muted)]">Latest Draw</span>
      ...
      <div className="grid grid-cols-4 gap-3 text-center">
        <div className="bg-[var(--color-bg)] rounded-lg p-2">
          <div className="text-xs text-[var(--color-muted)]">Sum</div>
          <div className="font-bold font-mono">{draw.sum_value}</div>
        </div>
        <div className="bg-[var(--color-bg)] rounded-lg p-2">
          <div className="text-xs text-[var(--color-muted)]">Odd:Even</div>
          <div className="font-bold font-mono">{draw.odd_count}:{draw.even_count}</div>
        </div>
        <div className="bg-[var(--color-bg)] rounded-lg p-2">
          <div className="text-xs text-[var(--color-muted)]">Big:Small</div>
          <div className="font-bold font-mono">{draw.big_count}:{draw.small_count}</div>
        </div>
        <div className="bg-[var(--color-bg)] rounded-lg p-2">
          <div className="text-xs text-[var(--color-muted)]">Streaks</div>
