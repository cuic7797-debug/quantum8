...
export default function AnalysisPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Collapsible title="🔥 频率排行 TOP 20" step={2} defaultOpen={false}>
      ...
      {/* 遗漏分析 */}
      <Collapsible title="📉 遗漏统计仪表盘" step={5}>
        <MissDashboard />
      </Collapsible>

      <Collapsible title="🔢 号码生命周期（冷热周期）" step={6} defaultOpen={false}>
        <NumberLifecycle />
      </Collapsible>

      {/* 相关性分析 */}
      <Collapsible title="🌡️ 号码热力图（80号码可视化）" step={7} defaultOpen={false}>
        <NumberHeatmap />
      </Collapsible>

      <Collapsible title="🔄 号码对比" step={8} defaultOpen={false}>
        <NumberCompare />
      </Collapsible>
